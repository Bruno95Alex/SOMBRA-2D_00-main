...
//         string[] lines =
//         {
//             "Você encontrou a chave do gerador… isso é bom.",
//             "Mas ainda falta uma coisa.",
//             "Mas o gerador precisa de uma bateria para funcionar.",
//             "Procure, ela esta aqui no prédio."
...
public class NPCInteraction : MonoBehaviour
{
    ...
    // Controla se o diálogo principal já foi mostrado
    ...
    private void Talk()
    {
        ...
        // Diálogo após a primeira conversa
        if (firstDialogueFinished)
        {
            string[] reminderLines =
            {
                "Vamos, siga em frente. Não temos tempo a perder."
            };

            DialogueUI.Instance.StartDialogue("Vigia", reminderLines);
            return;
        }
        ...
        string[] lines =
        {
            "Você encontrou a chave do gerador... isso é bom. Mas ainda falta uma coisa.",
            "O gerador também precisa de uma bateria para voltar a funcionar.",
            "Procure a bateria nas salas do prédio.",
            "Quando encontrá-la, vá até a sala do gerador.",
            "Estamos contando com você."
        };

        DialogueUI.Instance.StartDialogue("Vigia", lines);

        // Marca que o diálogo principal já foi exibido
